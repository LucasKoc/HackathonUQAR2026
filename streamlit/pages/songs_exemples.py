...
def show_song_exemples():
    ...
    with col1:
        st.subheader(
            "[Baleine à bosse](https://fr.wikipedia.org/wiki/Baleine_%C3%A0_bosse)"
        )
        try:
            ...
            st.warning(
                "Image baleine à bosse non trouvée. Assurez-vous que le chemin est correct."
            )
        try:
            ...
            st.warning(
                "Audio baleine à bosse non trouvé. Assurez-vous que le chemin est correct."
            )

    with col2:
        st.subheader(
            "[Bélugua](https://fr.wikipedia.org/wiki/B%C3%A9luga_(c%C3%A9tac%C3%A9))"
        )
        try:
            ...
            st.warning(
                "Image belugua non trouvée. Assurez-vous que le chemin est correct."
            )
        try:
            ...
            st.warning(
                "Audio bélugua non trouvé. Assurez-vous que le chemin est correct."
            )
    ...
    with col3:
        ...
        try:
            ...
            st.warning(
                "Image cachalot non trouvée. Assurez-vous que le chemin est correct."
            )
        try:
            ...
            st.warning(
                "Audio cachalot non trouvé. Assurez-vous que le chemin est correct."
            )

    with col4:
        st.subheader(
            "[Dauphin à flancs blancs](https://fr.wikipedia.org/wiki/Lagenorhynchus_acutus)"
        )
        try:
            image4 = Image.open(
            ...
            st.warning(
                "Image dauphin non trouvée. Assurez-vous que le chemin est correct."
            )
        try:
            audio4 = open(
                "streamlit/assets/songs/animals/white_sided_dolphin.mp3", "rb"
            )
            st.audio(audio4, format="audio/mp3")
        except FileNotFoundError:
            st.warning(
                "Audio dauphin non trouvé. Assurez-vous que le chemin est correct."
            )
    ...
    with col_center:
        ...
        try:
            ...
            st.warning(
                "Image rorqual commun non trouvée. Assurez-vous que le chemin est correct."
            )
        try:
            ...
            st.warning(
                "Audio rorqual commun non trouvé. Assurez-vous que le chemin est correct."
            )
